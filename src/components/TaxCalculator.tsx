/******************************************************************
 *  TaxCalculator.tsx  –  FBR-compliant (Tax Year 2025-26)
 ******************************************************************/
...
export const TaxCalculator: React.FC = () => {
  ...
  const result: TaxCalculation | null = useMemo(() => {
    ...
    return taxCalculator.calculateTax(
      categoryId,
      numericInput,
      isMonthlyCapable ? period === 'monthly' : false,
      includeZakat
    );
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 space-y-4 shadow">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          ...
          <div className={isMonthlyCapable ? '' : 'col-span-2'}>
            <label className="block text-sm font-medium mb-1">{fieldLabel[categoryId]} (PKR)</label>
          ...
          {cat.hasZakat && (
            <div className="flex items-center">
              ...
              />
              <label htmlFor="zakat" className="ml-2 text-sm">
                Include Zakat (2.5 %)
              </label>
            </div>
          )}
